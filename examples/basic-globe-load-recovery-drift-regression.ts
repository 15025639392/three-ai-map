...
export function runBasicGlobeLoadRecoveryDriftRegression(
  ...
  const cycleCount = 5;
  const surfaceTiles = new SurfaceTileLayer("basic-globe-load-recovery-drift-regression", {
    minZoom: 2,
    maxZoom: 10,
    tileSize: 128,
    meshSegments: 3,
  ...
  output.textContent = "booting:basic-globe-load-recovery-drift-regression";
...
export function bootstrap(): void {
  ...
  app.innerHTML = `
    <main class="demo-shell">
      ...
      <div class="demo-status" id="status-output">booting:basic-globe-load-recovery-drift-regression</div>
    </main>
  `;
