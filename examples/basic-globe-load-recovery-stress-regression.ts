...
export function runBasicGlobeLoadRecoveryStressRegression(
  ...
  const cycleCount = 3;
  const terrainSourceId = "basic-recovery-stress-terrain";
  ...
  const terrain = new TerrainTileLayer("basic-globe-load-recovery-stress-regression", {
  ...
  const rasterSourceId = "basic-recovery-stress-imagery";
  ...
  const rasterLayer = new RasterLayer({ id: "basic-recovery-stress-imagery", source: rasterSourceId });
...
export function bootstrap(): void {
  ...
  app.innerHTML = `
    <main class="demo-shell">
      ...
      <div class="demo-status" id="status-output">启动中:basic-globe-load-recovery-stress-regression</div>
    </main>
  `;
